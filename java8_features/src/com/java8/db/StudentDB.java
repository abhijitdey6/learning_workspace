...
public class StudentDB {
	...
	public static List<Student> getAllStudents(){
		...
		Student student5=new Student("Sophia", 4, 3.5, "male", 10, Arrays.asList("swimming","dancing","football"));
		Student student6=new Student("James", 4, 3.9, "female", 22, Arrays.asList("swimming","basketball","baseball","football"));
	...
	public static Optional<Student> getOptionalStudent(){
		...
		Bike bike=new Bike("Hayabusha", "800cc");
